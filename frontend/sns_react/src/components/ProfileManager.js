...
const ProfileManager = () => {
    ...
    const {profile, editedProfile, setEditProfile, deleteProfile, cover, setCover, createProfile, editProfile} = useContext(ApiContext)
        ...
        <div className={classes.profile}>
            ...
            { editProfile.id ? 
                (editProfile.nickName ?
                    <button className="user" onClick={(e)=>{editedProfile(); e.target.value=""}}><FaUserEdit/></button> :
                    <button className="user-invalid" disabled ><FaUserEdit/></button> )
                :
                (editProfile.nickName && cover.name ?
                    <button className="user" onClick={(e)=>{createProfile(); e.target.value=""}}><BsPersonPlus/></button> :
